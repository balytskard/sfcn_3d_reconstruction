...
class GradientReconstructor():
    ...
    def reconstruct(self, input_data, labels, img_shape=(1, 192, 160, 160), dryrun=False, eval=True, tol=None):
...
def reconstruction_costs(gradients, input_gradient, cost_fn='sim', indices='def', weights='equal'):
